import { collectArticles, toRefinedArticles, deriveSource } from "../articles";
...
describe("deriveSource", () => {
  it("should return the source from a valid link", () => {
    const testCases = [
      { link: "https://www.example.com", expected: "example" },
      { link: "https://subdomain.example.com", expected: "subdomain" },
      { link: "https://www.example.co.uk", expected: "example" },
      { link: "https://example.com/path/to/resource", expected: "example" },
    ];

    testCases.forEach((testCase) => {
      const result = deriveSource(testCase.link);
  ...
  it("should return undefined for an invalid link", () => {
    const testCases = [
      { link: "invalid-link", expected: undefined },
      { link: "https://www", expected: undefined },
      { link: "https://example", expected: undefined },
    ];
